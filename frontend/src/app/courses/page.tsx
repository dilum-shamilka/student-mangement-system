        ...
        <main className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 glass-card rounded-2xl p-4 border border-slate-800">
            ...
            <button
              ...
              className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-500 to-cyan-600 text-white font-medium text-xs shadow-lg shadow-indigo-500/20 hover:from-indigo-400 hover:to-cyan-500 transition-all flex items-center justify-center gap-2"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {filteredCourses.map((course) => (
              <div key={course.id} className="glass-card rounded-2xl p-5 border border-slate-800 flex flex-col justify-between relative group hover:border-slate-700 transition-all">
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-[11px] font-medium text-slate-400 flex items-center gap-1 bg-slate-900 px-2.5 py-1 rounded-md border border-slate-800">
                  ...
                  <div className="space-y-2 pt-3 border-t border-slate-800/60 text-xs">
                    <div className="flex items-center justify-between text-slate-300">
                      ...
                      <span className="font-medium flex items-center gap-1 text-slate-200">
                        <User className="w-3.5 h-3.5 text-cyan-400" /> {course.instructor}
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-slate-300">
                      <span className="text-slate-500">Department:</span>
                      <span className="font-medium text-slate-300">{course.department}</span>
                    </div>
                  </div>
                </div>
