        ...
        <main className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Distribution across major academic disciplines</p>
                </div>
                <span className="text-xs font-mono text-cyan-700 bg-cyan-50 px-3 py-1 rounded-full border border-cyan-100 font-medium">
                  Updated Live
                </span>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm flex flex-col justify-between">
              <div>
                <h2 className="text-base font-bold text-slate-900 mb-1">Quick Operations</h2>
                <p className="text-xs text-slate-500 mb-5">Frequently accessed administrative tasks</p>

                <div className="space-y-3">
                  <Link
                    href="/students"
                    className="w-full flex items-center justify-between p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-xs font-medium text-slate-700 hover:text-slate-900 transition-all group"
                  >
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6">
            <div className="flex items-center justify-between mb-5">
              <div>
                <h2 className="text-base font-bold text-slate-900">Recent Student Enrolments</h2>
                <p className="text-xs text-slate-500">Latest active student registrations</p>
              </div>
              <Link
                href="/students"
                ...
                <tbody className="divide-y divide-slate-100">
                  {students.slice(0, 5).map((student) => (
                    <tr key={student.id} className="hover:bg-slate-50/80 transition-colors">
                      <td className="p-3 font-mono font-medium text-indigo-600">{student.studentIdNumber}</td>
                      <td className="p-3 font-medium text-slate-900">{student.firstName} {student.lastName}</td>
